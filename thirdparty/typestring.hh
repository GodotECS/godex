...
#define TYPESTRING8(n, x) \
	irqus::tygrab<0x##n##0>(x), irqus::tygrab<0x##n##1>(x), irqus::tygrab<0x##n##2>(x), irqus::tygrab<0x##n##3>(x), irqus::tygrab<0x##n##4>(x), irqus::tygrab<0x##n##5>(x), irqus::tygrab<0x##n##6>(x), irqus::tygrab<0x##n##7>(x)

/* 2^4 = 16 */
#define TYPESTRING16(n, x) \
	irqus::tygrab<0x##n##0>(x), irqus::tygrab<0x##n##1>(x), irqus::tygrab<0x##n##2>(x), irqus::tygrab<0x##n##3>(x), irqus::tygrab<0x##n##4>(x), irqus::tygrab<0x##n##5>(x), irqus::tygrab<0x##n##6>(x), irqus::tygrab<0x##n##7>(x), irqus::tygrab<0x##n##8>(x), irqus::tygrab<0x##n##9>(x), irqus::tygrab<0x##n##A>(x), irqus::tygrab<0x##n##B>(x), irqus::tygrab<0x##n##C>(x), irqus::tygrab<0x##n##D>(x), irqus::tygrab<0x##n##E>(x), irqus::tygrab<0x##n##F>(x)
...
#define TYPESTRING64(n, x) \
	TYPESTRING16(n##0, x), TYPESTRING16(n##1, x), TYPESTRING16(n##2, x), TYPESTRING16(n##3, x)

/* 2^7 = 128 */
#define TYPESTRING128(n, x) \
	TYPESTRING16(n##0, x), TYPESTRING16(n##1, x), TYPESTRING16(n##2, x), TYPESTRING16(n##3, x), TYPESTRING16(n##4, x), TYPESTRING16(n##5, x), TYPESTRING16(n##6, x), TYPESTRING16(n##7, x)

/* 2^8 = 256 */
#define TYPESTRING256(n, x) \
	TYPESTRING16(n##0, x), TYPESTRING16(n##1, x), TYPESTRING16(n##2, x), TYPESTRING16(n##3, x), TYPESTRING16(n##4, x), TYPESTRING16(n##5, x), TYPESTRING16(n##6, x), TYPESTRING16(n##7, x), TYPESTRING16(n##8, x), TYPESTRING16(n##9, x), TYPESTRING16(n##A, x), TYPESTRING16(n##B, x), TYPESTRING16(n##C, x), TYPESTRING16(n##D, x), TYPESTRING16(n##E, x), TYPESTRING16(n##F, x)
...
#define TYPESTRING1024(n, x) \
	TYPESTRING256(n##0, x), TYPESTRING256(n##1, x), TYPESTRING256(n##2, x), TYPESTRING128(n##3, x), TYPESTRING16(n##38, x), TYPESTRING16(n##39, x), TYPESTRING16(n##3A, x), TYPESTRING16(n##3B, x), TYPESTRING16(n##3C, x), TYPESTRING16(n##3D, x), TYPESTRING16(n##3E, x), TYPESTRING16(n##3F, x)
