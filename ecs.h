...
enum Flags {
	...
	/// When specified the PipelineBuilder ignores the changed events generated by
	/// this system. This is useful to avoid show false positive warning about
	/// generated but uncatched changed events.
	BUILDER_IGNORE_WARNING_CHANGED_EVENTS = 1 << 0,
