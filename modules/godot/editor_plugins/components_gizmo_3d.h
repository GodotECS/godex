...
public:
	...
	virtual String get_handle_name(const EditorNode3DGizmo *p_gizmo, int p_idx, bool p_secondary) const override;
	virtual Variant get_handle_value(const EditorNode3DGizmo *p_gizmo, int p_idx, bool p_secondary) const override;
	virtual void set_handle(const EditorNode3DGizmo *p_gizmo, int p_idx, bool p_secondary, Camera3D *p_camera, const Point2 &p_point) override;
	virtual void commit_handle(const EditorNode3DGizmo *p_gizmo, int p_idx, bool p_secondary, const Variant &p_restore, bool p_cancel = false) override;
